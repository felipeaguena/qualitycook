      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">A Quality Cook</h2>
              <div className="w-20 h-1.5 bg-primary rounded-full"></div>
            </div>
            
            <p className="text-lg text-muted-foreground leading-relaxed">
              Inaugurada em 1994, a Quality Cook é uma Empresa Familiar que está atualmente em sua terceira geração de empreendedores. Atuando exclusivamente no atendimento e fornecimento de refeições corporativas.
            </p>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center text-foreground font-medium bg-background p-4 rounded-xl shadow-sm border border-border">
                  <CheckCircle className="text-primary w-6 h-6 mr-3 shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>

            <Link href="/sobre-a-quality-cook" className="inline-flex items-center text-primary font-semibold hover:text-primary/80 transition-colors group">
          ...
          <div className="relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl group border-4 border-background">
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-background/90 backdrop-blur p-6 rounded-2xl z-20 shadow-lg border border-border">
              ...
              <p className="text-sm font-medium text-muted-foreground">de estrutura própria e equipada para preparo com total segurança alimentar.</p>
            </div>
          </div>
