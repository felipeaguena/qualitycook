...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative py-24 bg-muted/50 overflow-hidden"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Entre em contato conosco e solicite um orçamento. <br />
              Estamos prontos para atender a sua empresa com a melhor qualidade
              e serviços personalizados de alimentação.
            </p>
