      ...
      <div className="bg-primary/10 py-16 md:py-24 border-b border-primary/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Atendimento personalizado de acordo com a necessidade de cada
            cliente, com adequação de cardápios, flexibilidade de horários e
            excelência na gestão alimentícia.
          </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-32">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6">
              A solução ideal para Empresas que buscam praticidade. Nossas
              refeições são preparadas na Cozinha Central da Quality Cook e
              acondicionadas em caixas térmicas “hot-box” que mantêm a
              temperatura e a qualidade.
            </p>
            <div className="bg-muted p-6 rounded mb-6 border border-primary/20">
              <h4 className="font-bold text-lg mb-3 flex items-center">
                <CheckCircle2 className="w-5 h-5 mr-2 text-primary" /> Ideal
                para:
              </h4>
              <ul className="space-y-2">
                <li className="text-muted-foreground">
                  Empresas sem Cozinha ou estrutura para preparo.
                </li>
                <li className="text-muted-foreground">
                  Empresas com pouco espaço físico.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl font-bold mb-4">
              Refeições Locais (In Company)
            </h2>
            <p className="text-lg text-muted-foreground mb-6">
              Esta é a solução completa em alimentação. Assumimos a gestão total
              do seu restaurante corporativo, desde o projeto arquitetônico até
              a operação diária na planta do cliente.
            </p>
            <ul className="space-y-4 mb-6">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center bg-blue-500/5 p-3 rounded-lg"
                >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center bg-orange-500/5 p-8 md:p-12 rounded-3xl border border-orange-500/20">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Buscando qualidade e praticidade para a alimentação dos seus
              colaboradores em ambientes de obra ou onde não há qualquer
              estrutura? O Quality Marmitex é a solução.
            </p>
            <div className="bg-background/80 backdrop-blur p-6 rounded-xl shadow-sm">
              <p className="font-medium text-foreground mb-2">
                Entregas seguras com embalagens térmicas e logísticas rápidas.
              </p>
              <p className="text-sm text-muted-foreground">
                Refeição nutritiva e balanceada, completa com arroz, feijão,
                proteína, guarnição, salada e sobremesa.
              </p>
            </div>
          </div>
